    ...
    return (
      <View style={{padding: SIZES.padding * 2}}>
        ...
        <FlatList
          ...
          /* KeyExtractor'da id'yi bu şekilde tanımlanmasının nedeni string döndürmek zorunda olmam Template Literals ${} ile bu işlem iyapıyorum */
...
/*  => (...) is implicit arrow function return. Parentheses are there for readability and consistency with multiline explicit return statement. It could be:
